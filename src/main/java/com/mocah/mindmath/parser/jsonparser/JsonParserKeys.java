...
public class JsonParserKeys {
	...
	// Optionals
	public static String TASK_EXPERT_MODE = "expertMode";
	public static String TASK_TEST_LRS = "useTestLRS";
	public static String TASK_VERBOSE = "verbose";
	...
	public static String SENSOR_LEARNER_ID = "idLearner";
